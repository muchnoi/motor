...
"")
        ...
        self.gridLayout.addWidget(self.ReturnButton, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.RightButton, 2, 4, 1, 1)
        ...
        MainWindow.setTabOrder(self.AutoScanButton, self.StepsBox)
