...
"QGroupBox#StatusGroupBox { border: 1px solid darkred; color: darkred;}")
        ...
        self.AcceBox = QtWidgets.QSpinBox(self.ConfigurationGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.AcceBox.sizePolicy().hasHeightForWidth())
        self.AcceBox.setSizePolicy(sizePolicy)
        self.AcceBox.setMinimumSize(QtCore.QSize(160, 0))
        self.AcceBox.setMinimum(32)
        self.AcceBox.setMaximum(65535)
        self.AcceBox.setSingleStep(100)
        self.AcceBox.setProperty("value", 100)
        self.AcceBox.setObjectName("AcceBox")
        self.gridLayout.addWidget(self.AcceBox, 0, 3, 1, 1)
        ...
        MainWindow.setTabOrder(self.VMaxBox, self.AcceBox)
        MainWindow.setTabOrder(self.AcceBox, self.IMoveBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AcceBox.setSuffix(_translate("MainWindow", " [s⁻²]"))
        self.AcceBox.setPrefix(_translate("MainWindow", "Accelerate: "))
